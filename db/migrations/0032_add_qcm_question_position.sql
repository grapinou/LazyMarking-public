-- +goose Up
CREATE TABLE qcm_questions_with_position (
...
INSERT INTO qcm_questions_with_position (id, qcm_id, question_id, user_id, position)
SELECT
    id,
    qcm_id,
    question_id,
...
ALTER TABLE qcm_questions_with_position RENAME TO qcm_questions;
...
-- +goose Down
CREATE TABLE qcm_questions_without_position (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    qcm_id INTEGER NOT NULL,
    question_id INTEGER NOT NULL,
    user_id INTEGER NOT NULL,
...
INSERT INTO qcm_questions_without_position (id, qcm_id, question_id, user_id)
SELECT id, qcm_id, question_id, user_id
FROM qcm_questions;

DROP TABLE qcm_questions;
ALTER TABLE qcm_questions_without_position RENAME TO qcm_questions;
